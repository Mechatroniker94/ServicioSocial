...
# 29 "../Master.X/configuracion.h" 2
# 7 "../Master.X/usart.c" 2
...
void usart_init(long BAUD){
    ...
    TRISCbits.TRISC6 = 0;
    TRISCbits.TRISC7 = 1;
    SPBRG = (unsigned char)(((20000000/BAUD)/64) - 1);
    TXSTAbits.BRGH = 0;
    TXSTAbits.SYNC = 0;
    RCSTAbits.SPEN = 1;
