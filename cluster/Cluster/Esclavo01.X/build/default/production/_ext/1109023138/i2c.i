...
# 2 "<built-in>" 2
# 1 "../Esclavo00.X/i2c.c" 2
# 1 "../Esclavo00.X/config.h" 1
...
# 27 "../Esclavo00.X/config.h" 2

# 1 "../Esclavo00.X/I2C.h" 1
void i2c_init(void);
void i2c_start(void);
...
# 28 "../Esclavo00.X/config.h" 2

# 1 "../Esclavo00.X/adc.h" 1
void adc_init(void);
...
int adc = 0;
# 29 "../Esclavo00.X/config.h" 2
# 1 "../Esclavo00.X/i2c.c" 2
# 10 "../Esclavo00.X/i2c.c"
void i2c_init(void){
